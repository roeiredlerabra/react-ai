...
const Lineup = () => {
  ...
  const headliners = [
    ...
    { id: 2, name: 'The Resonance', genre: 'Alternative Rock', image: 'https://images.unsplash.com/photo-1593697820940-41b3f0e58cba?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80' },
